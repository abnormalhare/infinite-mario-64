...
func try_add_star_data_entry(in_id : String, in_time : float, in_coins : int, in_red_coins : int, in_num_checkpoints : int):
	...
	if in_red_coins > red_coins:
		red_coins = in_red_coins
